    ...
    <header class="header header-image">
      <div class="container">
        ...
        <!-- Основной блок слайдера -->
         <?php include_once('./template-parts/swiper-top-block.php')?>

      </div>
      <!-- /.container -->
    </header>
    <?php include_once('./template-parts/plan-block.php')?>
    ...
    <section class="section blog">
      <div class="container">
        ...
        <!-- Slider main container -->
         <?php include_once('./template-parts/swiper-bottom-block.php')?>
      </div>
      <!-- /.container -->
    </section>
